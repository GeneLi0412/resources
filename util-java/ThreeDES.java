...
public class ThreeDES {
	 ...
	 * 必须长度必须16位
	 */
	private static final String BASE_64_Key="5a8fbf584fcd5619784cae67";
	...
	public static String encrypt(String str) {
		try {
			...
			DESedeKeySpec dks = new DESedeKeySpec(BASE_64_Key.getBytes("UTF-8"));
	...
	public static void main(String[] args) {
		...
		System.out.println(encrypt(money.toString()));
		
		System.err.println(decrypt("QPH96axP0fE="));
